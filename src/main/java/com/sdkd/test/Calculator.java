 ...
 * @author wei-li
 * 
 * The annotations determine the type of REST action to be applied to the method @GET, @PUT etc. 
 * The @Path annotation determines the URI of the request and the @Produces annotation determines how the response will be returned
 *
 */
@Path("calculator")
